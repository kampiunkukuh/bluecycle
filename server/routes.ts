...
api.get("/api/waste-catalog", async (req, res) => {
  try {
    ...
    if (allWaste.length === 0) {
      return res.json([
        { id: 1, wasteType: 'Plastik', description: 'Sampah plastik kemasan, botol', price: 100000, imageUrl: 'https://images.unsplash.com/photo-1611273426858-450d8e3c9fce?w=400&h=300&fit=crop' },
        { id: 2, wasteType: 'Kertas', description: 'Kertas bekas, kardus, majalah', price: 50000, imageUrl: 'https://images.unsplash.com/photo-1596208175030-f88a1fe6fdd3?w=400&h=300&fit=crop' },
        { id: 3, wasteType: 'Logam', description: 'Kaleng, besi, aluminium', price: 200000, imageUrl: 'https://images.unsplash.com/photo-1589939705066-5a101c786d13?w=400&h=300&fit=crop' },
        { id: 4, wasteType: 'Kaca', description: 'Botol kaca, pecahan kaca aman', price: 150000, imageUrl: 'https://images.unsplash.com/photo-1595433707802-6b2626ef1c91?w=400&h=300&fit=crop' },
        { id: 5, wasteType: 'Organik', description: 'Sisa makanan, daun, rumput', price: 30000, imageUrl: 'https://images.unsplash.com/photo-1584628688496-19a1a4e8dd3e?w=400&h=300&fit=crop' },
        { id: 6, wasteType: 'Elektronik', description: 'Barang elektronik lama, baterai', price: 300000, imageUrl: 'https://images.unsplash.com/photo-1585771724684-38269d6639fd?w=400&h=300&fit=crop' },
        { id: 7, wasteType: 'Kain/Tekstil', description: 'Pakaian lama, kain, tas', price: 75000, imageUrl: 'https://images.unsplash.com/photo-1585399743376-c9ce5737f9ac?w=400&h=300&fit=crop' },
        { id: 8, wasteType: 'Kayu', description: 'Palet kayu, furniture lama', price: 120000, imageUrl: 'https://images.unsplash.com/photo-1581613601352-dc0f6f30b5f3?w=400&h=300&fit=crop' },
      ]);
    }
    res.json(allWaste);
  } catch (error) {
...
// Collection points in Batam
api.get("/api/collection-points", async (req, res) => {
  try {
    const points = await storage.listCollectionPoints();
    if (points.length === 0) {
      return res.json([
        { id: 1, name: 'TPA Tanjung Riau', address: 'Jl. Pulau Riau, Tanjung Riau', latitude: '-1.1234', longitude: '104.5678', status: 'available', capacity: 10000, currentKg: 5200 },
        { id: 2, name: 'Pusat Daur Ulang Sungai Lada', address: 'Jl. Sungai Lada, Sungai Lada', latitude: '-1.1456', longitude: '104.6234', status: 'available', capacity: 8000, currentKg: 3500 },
        { id: 3, name: 'Bank Sampah Nongsa', address: 'Jl. Raya Nongsa, Nongsa', latitude: '-1.2123', longitude: '104.7123', status: 'available', capacity: 5000, currentKg: 1200 },
      ]);
    }
    res.json(points);
  } catch (error) {
