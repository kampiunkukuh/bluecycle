...
interface LoginUserProps {
  onLogin: (user: { id: number; name: string; email: string; role: "user" }) => void;
}

export default function LoginUser({ onLogin }: LoginUserProps) {
    ...
    >
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-white/90 text-lg">Masuk sebagai Pengguna</p>
        </div>
        ...
        <Card className="shadow-xl border-0">
          <CardHeader className="space-y-1 pb-6">
            ...
            <CardDescription className="text-base">
              Masuk untuk minta pengambilan sampah dan dapatkan reward
            </CardDescription>
          </CardHeader>
          <CardContent>
