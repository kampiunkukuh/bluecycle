    ...
    >
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-white/90 text-lg">Portal Administrator</p>
        </div>

        <Card className="shadow-xl border-0">
          <CardHeader className="space-y-1 pb-6">
            <CardTitle className="text-2xl font-bold">Masuk Admin</CardTitle>
            <CardDescription className="text-base">
              Akses dashboard manajemen sistem BlueCycle
            </CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleLogin} className="space-y-4">
              <div className="space-y-2">
                ...
                <Input
                  id="email"
                  type="email"
                  placeholder="admin@bluecycle.com"
                  value={email}
        ...
        <p className="text-center text-white/80 text-sm mt-6 text-xs">
          Hanya untuk administrator BlueCycle terverifikasi
        </p>
      </div>
    </div>
  );
